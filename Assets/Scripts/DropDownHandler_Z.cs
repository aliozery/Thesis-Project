...
public class DropDownHandler_Z : MonoBehaviour
{
    public GameObject drop_y;

    public GameObject drop_x;
    
    public int index_selected_y;
    ...
    void DropdownItemSelected(Dropdown dropdown)
    {
        ...
        //     if(index==index_selected_x || index==index_selected_y){
        //         Debug.Log("Already chosen");
        //     }
        //     else{
        //         drop_x.GetComponent<DropDownHandler_X>().index_selected_z=index;
        //         drop_y.GetComponent<DropDownHandler_Y>().index_selected_z=index;
        //         dataPlotter.GetComponent<DataPlotterAli>().index_z=index;

        //     }
        // }
        if(index < 4){
            if(index==index_selected_y){
                Debug.Log("Already Chosen");
            }
            else{
                drop_y.GetComponent<DropDownHandler_Y>().index_selected_z=index;
                dataPlotter.GetComponent<DataPlotterAli>().index_x=index+3;
